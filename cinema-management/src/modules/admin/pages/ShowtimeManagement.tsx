import { Calendar, Clock, Edit, Eye, Film, Filter, List, MapPin, Plus, Search, Trash2 } from 'lucide-react';
...
const ShowtimeManagement: React.FC = () => {
  ...
  const filteredShowtimes = showtimes.filter(showtime => {
    ...
    return matchesSearch && matchesMovie && matchesRoom && matchesDateFrom && matchesDateTo;
  });
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Quản lý lịch chiếu phim trong rạp</p>
          </div>
